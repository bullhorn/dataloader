...
public class ClientContact {
	...
	public String hourlyRateLow;
	public String middleName;
	public String mobile;
	public String namePrefix;
	public String nameSuffix;
	public String nickName;
	public String npsIsEnrolled;
	public String npsOptOut;
	...
	public String getNpsIsEnrolled() {
		return npsIsEnrolled;
	}
	public void setNpsIsEnrolled(String npsIsEnrolled) {
		this.npsIsEnrolled = npsIsEnrolled;
	}
	public String getNpsOptOut() {
		return npsOptOut;
	}
	public void setNpsOptOut(String npsOptOut) {
		this.npsOptOut = npsOptOut;
	}
