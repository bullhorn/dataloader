...
public class DeleteAttachmentsServiceTest {
    ...
    public void testIsValidArgumentsInvalidFile() {
        deleteAttachmentsService.isValidArguments(new String[]{Command.DELETE_ATTACHMENTS.getMethodName(), "filePath"});
    }

    @Test(expected = DataLoaderException.class)
    public void testIsValidArgumentsEmptyFile() {
        deleteAttachmentsService.isValidArguments(new String[]{Command.DELETE_ATTACHMENTS.getMethodName(), ""});
    }
