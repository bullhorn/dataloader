...
public class DeleteTaskTest {
    ...
    public void run_Success_Candidate() throws IOException, InstantiationException, IllegalAccessException {
        ...
        DeleteTask task = new DeleteTask(1, EntityInfo.CANDIDATE, dataMap, csvFileWriterMock, propertyFileUtilMock, restApiMock, printUtilMock, actionTotalsMock);
    ...
    public void run_Success_Appointment() throws IOException, InstantiationException, IllegalAccessException {
        final String[] expectedValues = {"1"};
        DeleteTask task = new DeleteTask(1, EntityInfo.APPOINTMENT, dataMap, csvFileWriterMock, propertyFileUtilMock, restApiMock, printUtilMock, actionTotalsMock);
    ...
    public void run_Success_Note() throws IOException, InstantiationException, IllegalAccessException {
        final String[] expectedValues = {"1"};
        DeleteTask task = new DeleteTask(1, EntityInfo.NOTE, dataMap, csvFileWriterMock, propertyFileUtilMock, restApiMock, printUtilMock, actionTotalsMock);
    ...
    public void run_Success_Placement() throws IOException, InstantiationException, IllegalAccessException {
        final String[] expectedValues = {"1"};
        DeleteTask task = new DeleteTask(1, EntityInfo.PLACEMENT, dataMap, csvFileWriterMock, propertyFileUtilMock, restApiMock, printUtilMock, actionTotalsMock);
    ...
    public void run_NonDeletableEntityFailure() throws IOException, InstantiationException, IllegalAccessException {
        final String[] expectedValues = {"1"};
        DeleteTask task = new DeleteTask(1, EntityInfo.CLIENT_CORPORATION, dataMap, csvFileWriterMock, propertyFileUtilMock, restApiMock, printUtilMock, actionTotalsMock);
    ...
    public void run_RestFailure() throws IOException, InstantiationException, IllegalAccessException {
        ...
        DeleteTask task = new DeleteTask(1, EntityInfo.CANDIDATE, dataMap, csvFileWriterMock, propertyFileUtilMock, restApiMock, printUtilMock, actionTotalsMock);
        when(restApiMock.search(eq(Candidate.class), eq("isDeleted:0 AND id:1"), any(), any())).thenReturn(TestUtils.getListWrapper(Candidate.class, 1));
        when(restApiMock.deleteEntity(any(), anyInt())).thenReturn(TestUtils.getResponse(ChangeType.DELETE, null, "FailureField", "Because failed"));
