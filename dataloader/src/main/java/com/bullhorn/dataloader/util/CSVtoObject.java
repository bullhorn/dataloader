package bullhorn.dataloader.util;
...
import bullhorn.dataloader.domain.Candidate;
import bullhorn.dataloader.domain.ClientContact;
import bullhorn.dataloader.domain.ClientCorporation;
import bullhorn.dataloader.domain.CustomObject;
import bullhorn.dataloader.domain.Lead;
import bullhorn.dataloader.domain.Opportunity;
import bullhorn.dataloader.domain.TranslatedType;
